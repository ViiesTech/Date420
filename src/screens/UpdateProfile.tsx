        ...
        return (
            <>    
                ...
                <View  style={{backgroundColor: Color('primary'),width: '100%',padding: 20,borderRadius: 5,marginTop: 5}}>
                            {/* <Text style={{color: Color('black')}}>{profileDetails?.birthday}</Text> */}
                    <DateTimePicker
                        mode="single"
                    ...
                    {/* <DateTimePickerModal
                             ...
                             onConfirm={(date) => { 
                                ...
                                setProfileDetails({...profileDetails,birthday: formattedDate})
                                // console.log('hello world',date.toDateString())
                                // setProfileDetails({...profileDetails,birthday: date.toDateString()})
                                 setShow(false)
                                }}
                         /> */}
                {/* <DatePicker
        ...
        return (
            <>
                ...
                <Input
                    ...
                    onChange={(text: any) => setAboutText(text)}
